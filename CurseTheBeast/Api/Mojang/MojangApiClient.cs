...
public class MojangApiClient : BaseApiClient
{
    ...
    { 
        return await GetAsync<GameVersions>(new Uri($"https://piston-meta.mojang.com/mc/game/version_manifest.json"), GameVersions.GameVersionsContext.Default.Version, ct);
    }
